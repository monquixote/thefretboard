...
abstract class Widgets {
    ...
    private function Connect() {
        ...
        $this->SphinxClient->SetMaxQueryTime((int)0); // $this->Settings['Admin']->MaxQueryTime); // Sets maximum search query time, in milliseconds. Default valus is 0 which means "do not limit".
