   ...
   public function DiscussionsController_AfterDiscussionTitle_Handler($Sender) {
      ...
      */
      ...
      if ($RenderCondition == "all" || $CompareType == $RenderCondition) {
          ...
          */
         echo '<span class="ReactSprite ReactInsightful" title="'.SliceString(strip_tags($Sender->EventArguments['Discussion']->Body),$TrimSize).'"></span>';
/*
Wrap("",$TrimSize), 'span', array(
            'class'  => "ReactSprite ReactQuote",
			'title'  => SliceString(strip_tags($Sender->EventArguments['Discussion']->Body)
         ));*/
      }
   }
