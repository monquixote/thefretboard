...
class WhosOnlinePlugin extends Gdn_Plugin {
   ...
   public function Base_Render_Before(&$Sender) {
      ...
      if (!InArrayI($Controller, $ShowOnController)) return; 
	   ...
	   // The following two lines modded by digitalscream 2013-08-01
	   // Change: upped default frequency from 4s to 300s
	   //         (couldn't find anywhere to set it elsewhere)
	   // Related change: class.whosonlinemodule.php, line 32
	   $Frequency = C('WhosOnline.Frequency', 300);
